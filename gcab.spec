...
Version  : 0.7
Release  : 1
URL      : ftp://ftp.gnome.org/pub/gnome/sources/gcab/0.7/gcab-0.7.tar.xz
Source0  : ftp://ftp.gnome.org/pub/gnome/sources/gcab/0.7/gcab-0.7.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1505429719
